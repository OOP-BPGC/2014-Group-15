...
<center>Username/Email Already Exists</center>
...
<div id="login">
  ...
  <h1>Registration Form</h1>
        <form method="post" action="./Registration">
            <input type="username" placeholder="First Name" name="firstName"/>
             <input type="username" placeholder="Last Name" name="lastName"/>
             <input type="username" placeholder="Email ID" name="email"/>
