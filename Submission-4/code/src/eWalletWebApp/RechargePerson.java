...
public class RechargePerson extends User {
	...
	public RechargePerson(String userName, String password) {
	...
	public boolean recharge(String receiver, double amount) {
	...
	public boolean getCredit(double amount){
		...
		if(VirtualBank.giveCredit(this.getUserName(), amount))
		{	this.getWallet().setBalance(this.getWallet().getBalance()+amount);
